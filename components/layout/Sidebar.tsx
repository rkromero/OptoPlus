        ...
        <>
            ...
            >
                ...
                <div className="border-t border-white/[0.06] p-2">
                    <DropdownMenu>
                        <DropdownMenuTrigger
                            className={cn(
                                "flex items-center gap-3 w-full rounded-lg px-3 py-2.5 hover:bg-white/[0.05] transition-colors cursor-pointer outline-none",
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#0D0D14]/90 backdrop-blur-md border-t border-white/[0.06] z-50 flex items-center justify-around px-1 pb-safe">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger
                        className={cn(
                            "flex flex-col items-center justify-center w-full h-full gap-1 transition-colors relative outline-none",
                            pathname.startsWith("/configuracion") ? "text-indigo-400" : "text-slate-400 hover:text-slate-200"
                        )}
                    >
                        <Avatar className="w-5 h-5 flex-shrink-0 relative z-10">
                            <AvatarFallback className="bg-indigo-500/20 text-indigo-300 text-[10px] font-semibold border border-indigo-500/20">
                                {session?.user?.name ? getInitials(session.user.name) : "U"}
                            </AvatarFallback>
                        </Avatar>
                        <span className="text-[10px] font-medium relative z-10">Perfil</span>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent side="top" align="end" className="w-48 bg-[#111118] border-white/[0.08] mb-2 shadow-2xl">
                        <div className="px-2 py-1.5 opacity-70">
                        ...
                        {isAdmin && (
                            <>
                                <DropdownMenuItem onClick={() => router.push("/configuracion")} className="cursor-pointer text-slate-300 hover:text-white flex items-center w-full">
